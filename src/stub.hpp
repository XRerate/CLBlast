#ifndef CLBLAST_STUB_H_
#define CLBLAST_STUB_H_
...
bool LoadOpenCL(const char *library_path = "libOpenCL.so");
...
// Note: this is an official extension from Khronos group.
...
#ifdef QCOM
typedef cl_mem(CL_API_CALL *PFN_clCreateBufferFromImageQCOM)(
    cl_mem /*image*/, cl_mem_flags /*flags*/, cl_int * /*errcode_ret*/);

typedef cl_int(CL_API_CALL *PFN_clSetPerfHintQCOM)(cl_context /*context*/,
...
typedef cl_int(CL_API_CALL *PFN_clRetainRecordingQCOM)(cl_recording_qcom);

typedef cl_int(CL_API_CALL *PFN_clEnqueueRecordingQCOM)(
    cl_command_queue /*command_queue*/, cl_recording_qcom /*recording*/,
...
typedef cl_int(CL_API_CALL *PFN_clEnqueueRecordingSVMQCOM)(
    cl_command_queue /*command_queue*/, cl_recording_qcom /*recording*/,
    size_t /*number of recorded args being updated*/,
    const cl_array_arg_qcom * /*recorded arg to update*/,
    ...
    const cl_array_kernel_exec_info_qcom * /*Array of non argument kernel
                                              parameters to update*/
    ,
    cl_uint /*num_events_in_wait_list*/, const cl_event * /*event_wait_list*/,
    cl_event * /*event*/);

typedef cl_int(CL_API_CALL *PFN_clQueryImageInfoQCOM)(
    cl_device_id device, cl_mem_flags flags,
    const cl_image_format *image_format, const cl_image_desc *image_desc,
    cl_extended_image_info_qcom param_name, size_t param_value_size,
    void *param_value, size_t *param_value_size_ret);
#endif // QCOM
...
#ifdef CL_VERSION_2_2
extern PFN_clSetProgramSpecializationConstant
...
// Qualcomm extensions
#ifdef QCOM
extern PFN_clCreateBufferFromImageQCOM clCreateBufferFromImageQCOM;
...
extern PFN_clRetainRecordingQCOM clRetainRecordingQCOM;
extern PFN_clEnqueueRecordingQCOM clEnqueueRecordingQCOM;
extern PFN_clEnqueueRecordingSVMQCOM clEnqueueRecordingSVMQCOM;
extern PFN_clQueryImageInfoQCOM clQueryImageInfoQCOM;
#endif // QCOM

#endif // CLBLAST_STUB_H_